...
** =Setup/setupFile-X.org=

#+NAMES: setupFile.org 
#+BEGIN_SRC org :tangle yes :tangle "../Setup/setupFile.org" :tangle-mode (identity #o444)
...
#+NAMES: setupFile-1.org 
#+BEGIN_SRC org :tangle yes :tangle "../Setup/setupFile-1.org" :tangle-mode (identity #o444)
,#+SETUPFILE: options.org
,#+HTML_HEAD: <link rel="stylesheet" type="text/css" href="http://orgmode.org/worg/style/worg.css"/>
,#+HTML_HEAD: <style type="text/css">body{ max-width:80%; }</style>
,#+INFOJS_OPT: view:showall mouse:underline path:http://orgmode.org/org-info.js home:../theindex.html 
...
#+NAMES: setupFile-2.org 
#+BEGIN_SRC org :tangle yes :tangle "../Setup/setupFile-2.org" :tangle-mode (identity #o444)
,#+SETUPFILE: options.org
,#+HTML_HEAD: <link rel="stylesheet" type="text/css" href="http://orgmode.org/worg/style/worg.css"/>
,#+HTML_HEAD: <style type="text/css">body{ max-width:80%; }</style>
,#+INFOJS_OPT: view:showall mouse:underline path:http://orgmode.org/org-info.js home:../../theindex.html 
...
#+NAMES: setupFile-3.org 
#+BEGIN_SRC org :tangle yes :tangle "../Setup/setupFile-3.org" :tangle-mode (identity #o444)
,#+SETUPFILE: options.org
,#+HTML_HEAD: <link rel="stylesheet" type="text/css" href="http://orgmode.org/worg/style/worg.css"/>
,#+HTML_HEAD: <style type="text/css">body{ max-width:80%; }</style>
,#+INFOJS_OPT: view:showall mouse:underline path:http://orgmode.org/org-info.js home:../../../theindex.html 
...
#+NAMES: setupFile-4.org 
#+BEGIN_SRC org :tangle yes :tangle "../Setup/setupFile-4.org" :tangle-mode (identity #o444)
,#+SETUPFILE: options.org
,#+HTML_HEAD: <link rel="stylesheet" type="text/css" href="http://orgmode.org/worg/style/worg.css"/>
,#+HTML_HEAD: <style type="text/css">body{ max-width:80%; }</style>
,#+INFOJS_OPT: view:showall mouse:underline path:http://orgmode.org/org-info.js home:../../../../theindex.html 
...
#+NAMES: options.org 
#+BEGIN_SRC org :tangle yes :tangle "../Setup/options.org"
