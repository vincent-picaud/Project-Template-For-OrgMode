...
** Bibliography 
   ...
   This part configure bibliography integration.

*** =bibliography.bib=
    #+INDEX:file!bibliography.bib 

    First, one must create a bibliography file.

    #+BEGIN_SRC bib :tangle yes :tangle bibliograpy.bib 
...
** TODO =example=
   ...
   This is a page demo to check it works. The =setupfile= location is
   automatically defined as explained in
...
The complete =example.org= file is:
