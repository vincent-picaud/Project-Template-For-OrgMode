...
#+BEGIN_SRC 
firefox   MyProject/theindex.html
#+END_SRC
...
#+BEGIN_SRC bash :tangle create_orgMode_project :shebang #!/bin/bash :exports code :eval never
#################
# Parse command #
#################
...
(if my-project-root
	...
	(setq org-capture-templates
	      ...
	      ;; )
	      ;;
	      ;; ("L" "Log Time" entry (file+datetree "~/GitLab/PVBibliography/activity.org" "Activity")
	      ;; "* %U - %^{Activity}  :TIME:"
	      ;; )
